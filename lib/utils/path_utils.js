...
module.exports = {
	...
	getBasename: function(request_path, file_extension) {
		...
		var extension_start_pos = request_path.length - file_extension.length;
		if ( request_path.indexOf(file_extension) === extension_start_pos ) {
		 	return request_path.substr(0, extension_start_pos) 
		} else {
			return request_path;	
		}	
	}
