...
module.exports = {
  ...
  generate: function(supplied_config, on_start, on_complete){

    var self = this;

    var on_start = (typeof on_start === "function") ? on_start : function(c){ c() };
    var on_complete = (typeof on_complete === "function") ? on_complete : function(c){ c() };
