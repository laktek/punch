...
module.exports = {
	...
	renderContent: function(request_path, content_type, last_modified, options, callback){
		...
		self.contents.negotiateContent(basepath, content_type, options, function(err, content_obj, last_modified){
			template_engine.setContent(content_obj, last_modified);
		});

		self.templates.negotiateTemplate(basepath, template_engine.extension, options, function(err, template_output, last_modified){
			if(err){
				return callback(err, null);	
			}
		...
		self.templates.getPartials(basepath, template_engine.extension, options, function(err, partials, last_modified){
