...
module.exports = {
  ...
  registeredRenderers: {},
	...
	renderContent: function(request_path, content_type, last_modified, options, callback){
		...
		self.templates.negotiateTemplate(basepath, template_engine.extension, options, function(template_output, partials, last_modified){
			template_engine.setTemplate(template_output, partials, last_modified);
		});
	},
