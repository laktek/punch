...
describe("setting template", function() {
  ...
  it("calls render if the content is already set", function(){
  ...
  it("does not call render if the content is not already set", function(){
...
describe("setting content", function() {
  ...
  it("calls render if the template is already set", function(){
  ...
  it("does not call render if the template is not already set", function(){
